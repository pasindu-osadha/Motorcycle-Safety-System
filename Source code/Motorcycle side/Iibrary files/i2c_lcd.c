...
//=================================================================
// write a number on LCD
//=================================================================

void lcd_write_number(int x_position,int y_position,int number, unsigned char radix)
{
...
//=================================================================
// write a sample string on the LCD
//=================================================================

void lcd_write_a_sample_string(int x_position1,int y_position1,char * sample_string1)
{
	
	lcd_goto_xy(x_position1,y_position1);
	lcd_puts(sample_string1);
}

//=================================================================
// write two sample string on the LCD
//=================================================================

void lcd_write_two_sample_strings(int x_position1,int y_position1,char * sample_string1,int x_position2,int y_position2,char * sample_string2)
	{
		
		lcd_goto_xy(x_position1,y_position1);
		lcd_puts(sample_string1);	
		lcd_goto_xy(x_position2,y_position2);
		lcd_puts(sample_string2);
	}
